          ...
          <div className='app_content'>
            ...
            <div className='app_btns d-flex align-items-center gap-5 mt-4'>
              <button className='btn_instagram d-flex align-items-center gap-3'>
                <i class="ri-instagram-line"></i><a href='https://www.instagram.com/kolyba.restaurant/?next=%2F'>Instagram</a>
              </button>

              <button className='btn_twitter d-flex align-items-center gap-3'>
                <i class="ri-twitter-line"></i><a href='https://twitter.com/kolybarest11751'>Twitter</a>
              </button>
            </div>
